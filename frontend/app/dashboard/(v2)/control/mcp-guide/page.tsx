...
export default function DashboardMcpGuidePage() {
  ...
  return (
    <section className="space-y-5">
      <h1 className="text-2xl font-bold tracking-tight leading-8">MCP Guide</h1>
      <p className="text-[13px] leading-5 text-muted-foreground">Quick copy examples for JSON-RPC `list_tools` and `call_tool` usage.</p>

      <article className="ds-card p-4">
        <div className="mb-2 flex items-center justify-between gap-2">
          <p className="text-sm font-semibold">1) List tools</p>
          <button
            type="button"
        ...
        <pre className="overflow-x-auto rounded bg-muted/50 p-3 text-[11px] text-muted-foreground">{examples.listTools}</pre>
      </article>

      <article className="ds-card p-4">
        <div className="mb-2 flex items-center justify-between gap-2">
          <p className="text-sm font-semibold">2) Call tool</p>
          <button
            type="button"
        ...
        <pre className="overflow-x-auto rounded bg-muted/50 p-3 text-[11px] text-muted-foreground">{examples.callTool}</pre>
      </article>
