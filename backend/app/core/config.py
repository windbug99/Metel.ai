...
class Settings(BaseSettings):
    ...
    canva_scopes: str = "profile:read design:meta:read design:content:read design:content:write asset:read asset:write comment:read comment:write brandtemplate:meta:read brandtemplate:content:read folder:read folder:write"
